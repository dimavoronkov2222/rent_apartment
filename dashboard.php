    ...
    <ul class="list-group mb-4">
        <?php foreach ($rentals as $rental): ?>
            <li class="list-group-item">
                ...
                <a href="?delete=<?php echo $rental['id']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure you want to delete this rental property?');">Delete</a>
            </li>
        <?php endforeach; ?>
    </ul>
    ...
    <div class="modal fade" id="addRentalModal" tabindex="-1" role="dialog" aria-labelledby="addRentalModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="dashboard.php" method="post" enctype="application/x-www-form-urlencoded">
